...
Gamedev AI প্লাগিনটিতে **২৭টি ইন্টিগ্রেটেড টুল** রয়েছে যা কথোপকথনের সময় AI স্বয়ংক্রিয়ভাবে ব্যবহার করতে পারে। এই টুলগুলো হলো AI এর "যান্ত্রিক হাত" যার মাধ্যমে সে সরাসরি Godot ইঞ্জিনের সাথে যোগাযোগ করে। নিচে ক্যাটাগরি অনুযায়ী প্রতিটি টুলের বিবরণ দেওয়া হলো:
...
### `run_tests`
একটি টেস্ট স্ক্রিপ্ট বা কমান্ড রান করে। GUT, GdUnit4 অথবা কাস্টম টেস্ট স্ক্রিপ্ট দিয়ে পরিবর্তনগুলো ভেরিফাই করার জন্য এটি কার্যকর।
- **প্যারামিটার:** `test_script_path` (অপশনাল)
