...
### নিচের সুইচসমূহ (Bottom Switches)
| সুইচ | ফাংশন |
|--------|--------|
| **Context** | অ্যাক্টিভ হলে: প্লাগিনটি অটোমেটিক এডিটরে খোলা থাকা স্ক্রিপ্টের সম্পূর্ণ বিষয়বস্তু আপনার মেসেজের সাথে পাঠিয়ে দেয়। |
| **Screenshot** | অ্যাক্টিভ হলে: Godot উইন্ডোর একটি স্ক্রিনশট নিয়ে ভিজ্যুয়াল অ্যানালাইসিসের জন্য AI কে পাঠিয়ে দেয়। |
| **Plan First** | অ্যাক্টিভ হলে: AI সরাসরি কোড লিখবে না, বরং একটি বিস্তারিত Markdown প্ল্যান দেবে। রিভিউ করার পর "Execute Plan" এ ক্লিক করতে হবে। |
| **Watch Mode** | অ্যাক্টিভ হলে: AI অটোমেটিক Godot আউটপুট কনসোল মনিটর করে। ক্রিটিক্যাল এরর (লাল) পাওয়ার সাথে সাথে অটো-ফিক্স প্রস্তাব দেয়। সাইলেন্ট পিরিয়ড: ৩০ সেকেন্ড, লিমিট: প্রতি সাইকেলে ৩টি ফিক্স। |
