...
## O Botão de "Resumir para Memória"

Na aba central superior do painel de Chat `(ao lado do botão History)`, repousa o botão brilhante de **💾 Resumir para Memória**.
...
1. No fim do dia, aperte **Resumir para Memória**.
