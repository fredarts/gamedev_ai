...
Gamedev AI में **27 एकीकृत टूल** हैं जिन्हें एआई बातचीत के दौरान स्वायत्त रूप से कॉल कर सकता है। ये उपकरण "मैकेनिकल आर्म" हैं जो एआई को सीधे Godot इंजन के साथ बातचीत करने की अनुमति देते हैं। प्रत्येक टूल का वर्णन नीचे श्रेणियों के अनुसार किया गया है।
...
### `view_file_outline`
पूर्ण कोड के बिना स्क्रिप्ट की संरचना लौटाता है: `class_name`, `extends`, फ़ंक्शंस, सिग्नल, एक्सपोर्ट्स, एनम्स, इनर क्लासेज और लाइन नंबरों के साथ स्थिरांक (Constants)।
- **पैरामीटर्स:** `path`
...
### `run_tests`
एक टेस्ट स्क्रिप्ट या कमांड चलाता है। GUT, GdUnit4 या कस्टम टेस्ट स्क्रिप्ट के साथ परिवर्तनों की जांच के लिए उपयोगी।
