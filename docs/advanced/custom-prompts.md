...
Na aba oculta **Settings**, role abaixo do campo da provedor de "API Key".
Existe a grandiosa caixa livre **Custom Instructions (appended to system prompt)**.
...
Com isso, o Gamedev AI se transforma em um desenvolvedor Júnior moldado especificamente pelo CTO (Você) e codará do jeito que sua equipe aprovar ao invés da sintaxe livre convencional dos LLMs.
