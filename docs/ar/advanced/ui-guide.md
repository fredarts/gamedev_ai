...
### المفاتيح السفلية (Bottom Switches)
| المفتاح | الوظيفة |
|--------|--------|
| **Context** | نشط: يرفق الملحق تلقائياً المحتوى الكامل للسكربت المفتوح حالياً في المحرر بالرسالة المرسلة. |
| **Screenshot** | نشط: يأخذ لقطة شاشة لنافذة Godot ويرسلها للذكاء الاصطناعي للتحليل البصري. |
| **Plan First** | نشط: لا يكتب الذكاء الاصطناعي كوداً ، بل يرد بخطة Markdown مفصلة فقط. انقر فوق "Execute Plan" بعد المراجعة. |
| **Watch Mode** | نشط: يراقب الذكاء الاصطناعي وحدة تحكم مخرجات Godot تلقائياً. في حالة وجود أخطاء حرجة (حمراء) ، يقترح إصلاحات تلقائية. فترة الهدوء: 30 ثانية ، الحد: 3 إصلاحات لكل دورة. |
