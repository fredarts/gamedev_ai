...
يمتلك Gamedev AI **27 أداة متكاملة** يمكن للذكاء الاصطناعي استدعاؤها بشكل مستقل أثناء المحادثة. هذه الأدوات هي "الأذرع الميكانيكية" التي تسمح للذكاء الاصطناعي بالتفاعل مباشرة مع محرك Godot. يتم وصف كل أداة أدناه حسب الفئة.
...
### `run_tests`
ينفذ سكربت أو أمر اختبار. مفيد للتحقق من التغييرات مع GUT أو GdUnit4 أو سكربتات اختبار مخصصة.
- **المعاملات:** `test_script_path` (اختياري)
